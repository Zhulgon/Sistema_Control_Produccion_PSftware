...
def run_demo() -> dict:
    client = MESProductionClient(LegacyMachineAdapter(LegacyMachineGateway()))
    result = client.close_partial_report("OP-2026-FUNC-ADA", "line-a", 570)
    return {"legacy_sync": result}
