...
def run_demo() -> dict:
    console = MESOperatorConsole(MESProductionFacade())
    return {
        "valid_order": console.run_startup("OP-2026-FUNC-FAC", "LINE-A", 600),
        "invalid_order": console.run_startup("BAD", "LINE-A", 0),
    }
